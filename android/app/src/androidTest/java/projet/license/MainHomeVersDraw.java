...
public class MainHomeVersDraw {
    ...
    public void mainHomeVersDraw() {
        ...
        intended(allOf(hasComponent(hasShortClassName(".DrawDetectorActivity")),toPackage(PACKAGE_NAME)));
    }



    @Test
    public void mainHomeVersTime() {
        ViewInteraction button = onView(
                allOf(withId(R.id.TimeDetector), withText("TIME DETECTOR"),
                        ...
                        isDisplayed()));
        button.perform(click());
        intended(allOf(hasComponent(hasShortClassName(".TimeDetectorActivity")),toPackage(PACKAGE_NAME)));
