...
public class shapedetectorTest {
    ...
    public void detectShapes() throws IOException {
        ...
        BufferedReader br = new BufferedReader(new FileReader("C:/Users/Kyriakos Petrou/Desktop/Projet2/PLFGJ-master/javastd/commun/src/main/test/commun/ressources.txt"));
        String base64;
        Integer compter = 0;
